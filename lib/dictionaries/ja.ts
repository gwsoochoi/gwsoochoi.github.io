...
const ja: Dictionary = {
  meta: {
    title: "チェ・グァンス | プロダクトビルダー ・ ソフトウェアエンジニア",
    description: "チェ・グァンスのポートフォリオ - プロダクトビルダー ・ ソフトウェアエンジニア",
  },
  nav: { about: "About", resume: "履歴書", posts: "ポスト" },
  profile: {
    name: "チェ・グァンス",
    role: "プロダクトビルダー ・ ソフトウェアエンジニア",
    imageAlt: "チェ・グァンス プロフィール写真",
    bio: [
      `東京在住(${tokyoYears}年目)、開発経験${careerYears}年の韓国人プロダクトビルダー ・ ソフトウェアエンジニアです。`,
  ...
  about: {
    greeting: "こんにちは",
    description: [
      "東京でモバイルアプリを一人で企画・開発・運営しているプロダクトビルダーです。",
      "AIを積極的に活用し、企画からマーケティングまで自分でやりながら、一人ユニコーン企業を目指しています。",
      "フリーランスのフルスタックエンジニアとして中・長期の業務委託も可能です。",
    ],
  },
  posts: {
    title: "ポスト",
